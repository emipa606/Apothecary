    ...
    public class AYBitsUtility
    {
            ...
            if (defName != "AYCalciumCarbonate")
            {
                ...
                if (defSource != null)
                {
                    if (defSource.defName == "ChunkLimestone" || defSource.defName == "ChunkMarble" ||
                        defSource.defName == "ChunkEmperadordark" || defSource.defName == "ChunkCreoleMarble" ||
                        defSource.defName == "ChunkEtowahMarble" || defSource.defName == "ChunkChalk" ||
                        defSource.defName == "ChunkLignite" || defSource.defName == "ChunkSovite" ||
                        defSource.defName == "ChunkDacite" || defSource.defName == "ChunkBlueschist" ||
                        defSource.defName == "ChunkGreenSchist" || defSource.defName == "ChunkSyenite")
                    {
        ...
        internal static bool GetBitsSource(ThingDef def)
        {
            ...
            else if (num <= 3134642644U)
            {
                switch (num)
                {
                    case <= 2223887258U when num <= 1807593693U:
                    {
                        if (num != 1789891285U)
                        {
                            if (num != 1807593693U)
